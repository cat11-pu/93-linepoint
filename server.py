...
ENGINE = Timeline()
ROUTES = {
    "/commit": lambda payload: ENGINE.commit(payload["key"], payload["value"], payload["at"]),
    "/read": lambda payload: ENGINE.read(payload["key"], payload["at"]),
    "/line_point": lambda payload: ENGINE.line_point(payload["seq"]),
    "/visible": lambda payload: ENGINE.visible_at(payload["seq"]),
